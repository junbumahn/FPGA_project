...
HD_PWD='C:/FPGA/practice_project/blink_led_project/blink_led_bd/blink_led_bd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blink_led_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blink_led_bd_wrapper.tcl -notrace
