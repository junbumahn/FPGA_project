...
HD_PWD='C:/FPGA/practice_project/blink_led_project/blink_led_bd/blink_led_bd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blink_led_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blink_led_bd_wrapper.tcl
