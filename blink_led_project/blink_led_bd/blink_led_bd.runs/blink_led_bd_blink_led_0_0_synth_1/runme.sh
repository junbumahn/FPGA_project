...
HD_PWD='C:/FPGA/practice_project/blink_led_project/blink_led_bd/blink_led_bd.runs/blink_led_bd_blink_led_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blink_led_bd_blink_led_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blink_led_bd_blink_led_0_0.tcl
