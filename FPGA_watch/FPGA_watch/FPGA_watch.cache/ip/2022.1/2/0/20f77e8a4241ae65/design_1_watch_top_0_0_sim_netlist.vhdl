...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_watch_op is
  port (
    ...
    \FSM_sequential_c_state_reg[0]_2\ : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    SR : in STD_LOGIC_VECTOR ( 0 to 0 );
    btn : in STD_LOGIC_VECTOR ( 2 downto 0 );
    \FSM_sequential_c_state_reg[0]_3\ : in STD_LOGIC;
    r_run : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_watch_op is
  ...
  signal \r_sec[5]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \led[0]_INST_0\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \led[1]_INST_0\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \led[2]_INST_0\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of r_done_i_1 : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \r_hour[0]_i_1\ : label is "soft_lutpair41";
  ...
  attribute SOFT_HLUTNM of r_pausing_i_1 : label is "soft_lutpair51";
  ...
  attribute SOFT_HLUTNM of \r_sec[5]_i_3\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \slv_reg3[10]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \slv_reg3[11]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \slv_reg3[13]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \slv_reg3[14]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \slv_reg3[15]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \slv_reg3[16]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \slv_reg3[17]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \slv_reg3[1]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \slv_reg3[2]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \slv_reg3[3]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \slv_reg3[4]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \slv_reg3[5]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \slv_reg3[7]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \slv_reg3[8]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \slv_reg3[9]_i_1\ : label is "soft_lutpair45";
begin
\FSM_sequential_c_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3E323E023E3E3E0E"
        ...
        port map (
      I0 => \FSM_sequential_c_state_reg[0]_3\,
      I1 => c_state(0),
      I2 => c_state(1),
      I3 => btn(0),
      I4 => btn(2),
...
r_done_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\r_sec[5]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_watch_top is
  ...
  signal u_watch_op_n_18 : STD_LOGIC;
  signal u_watch_op_n_19 : STD_LOGIC;
...
AXI4_Lite_IP_v1_0_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4_Lite_IP_v1_0
     port map (
      ...
      r_done_reg => u_watch_op_n_18,
      r_idle_reg => u_watch_op_n_21,
      r_pausing_reg => u_watch_op_n_19,
      r_run => \AXI4_Lite_IP_v1_0_S00_AXI_inst/r_run\,
      r_running_reg => u_watch_op_n_20,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_araddr(1 downto 0) => s00_axi_araddr(1 downto 0),
      s00_axi_aresetn => s00_axi_aresetn,
      s00_axi_arvalid => s00_axi_arvalid,
...
u_watch_op: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_watch_op
     port map (
      ...
      D(1) => AXI4_Lite_IP_v1_0_inst_n_37,
      D(0) => AXI4_Lite_IP_v1_0_inst_n_38,
      \FSM_sequential_c_state_reg[0]_0\ => u_watch_op_n_18,
      \FSM_sequential_c_state_reg[0]_1\ => u_watch_op_n_19,
      \FSM_sequential_c_state_reg[0]_2\ => u_watch_op_n_21,
      \FSM_sequential_c_state_reg[0]_3\ => AXI4_Lite_IP_v1_0_inst_n_39,
      Q(0) => \AXI4_Lite_IP_v1_0_S00_AXI_inst/p_0_in3_in\,
      SR(0) => AXI4_Lite_IP_v1_0_inst_n_1,
      ...
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
      s00_axi_aresetn_0 => u_watch_op_n_20
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
