...
HD_PWD='C:/FPGA/FPGA_project/FPGA_watch_ver3/FPGA_watch/FPGA_watch.runs/design_1_watch_top_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_watch_top_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_watch_top_0_2.tcl
